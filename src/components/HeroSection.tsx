        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="flex flex-col space-y-6 md:pr-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-dark animate-fadeIn">
              Ветеринарная помощь <span className="text-primary">с выездом на дом</span>
            </h1>
            <p className="text-lg md:text-xl text-gray-600 animate-fadeIn" style={{ animationDelay: "0.2s" }}>
              Профессиональная забота о здоровье вашего питомца в комфортной для него обстановке. Без стресса, очередей и поездок.
            </p>
            ...
            <div className="flex items-center gap-6 pt-6 animate-fadeIn" style={{ animationDelay: "0.6s" }}>
              <div className="flex -space-x-4">
                <img src="https://images.unsplash.com/photo-1552058544-f2b08422138a?w=150&h=150&fit=crop" alt="Ветеринар" className="w-12 h-12 rounded-full border-2 border-white" />
                <img src="https://images.unsplash.com/photo-1537151625747-768eb6cf92b2?w=150&h=150&fit=crop" alt="Ветеринар" className="w-12 h-12 rounded-full border-2 border-white" />
                <img src="https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=150&h=150&fit=crop" alt="Ветеринар" className="w-12 h-12 rounded-full border-2 border-white" />
              </div>
              <div>
          ...
          <div className="relative md:h-[600px] animate-fadeIn" style={{ animationDelay: "0.3s" }}>
            ...
            <div className="relative h-full flex justify-center">
              ...
              {/* Floating badges */}
              <div className="absolute top-10 -left-6 md:top-20 md:-left-12 bg-white p-4 rounded-xl shadow-lg animate-fadeIn flex items-center gap-3" style={{ animationDelay: "0.7s" }}>
              ...
              <div className="absolute bottom-10 -right-6 md:bottom-20 md:-right-12 bg-white p-4 rounded-xl shadow-lg animate-fadeIn flex items-center gap-3" style={{ animationDelay: "0.9s" }}>
